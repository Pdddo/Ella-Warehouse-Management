                            ...
                            <div>
                                ...
                                <div class="mt-4 grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="buy_price" class="block mt-1 w-full" type="number" step="0.01" name="buy_price" :value="old('buy_price')" required />
                                        <x-input-error :messages="$errors->get('buy_price')" class="mt-2" />
                                    </div>
                                    <div>
                                        <x-input-label for="sell_price" :value="__('Harga Jual (Rp)')" />
                                        <x-text-input id="sell_price" class="block mt-1 w-full" type="number" step="0.01" name="sell_price" :value="old('sell_price')" required />
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="min_stock" class="block mt-1 w-full" type="number" name="min_stock" :value="old('min_stock')" required />
                                ...
                                <div class="mt-4 grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="rack_location" class="block mt-1 w-full" type="text" name="rack_location" :value="old('rack_location')" />
